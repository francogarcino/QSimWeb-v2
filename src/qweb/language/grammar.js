...
grammar = {
    ...
    {"name": "OperationT1$subexpression$1", "symbols": [/[mM]/, /[oO]/, /[vV]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$1"]},
    {"name": "OperationT1$subexpression$2", "symbols": [/[aA]/, /[dD]/, /[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$2"]},
    {"name": "OperationT1$subexpression$3", "symbols": [/[aA]/, /[nN]/, /[dD]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$3"]},
    {"name": "OperationT1$subexpression$4", "symbols": [/[oO]/, /[rR]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$4"]},
    {"name": "OperationT1$subexpression$5", "symbols": [/[sS]/, /[uU]/, /[bB]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$5"]},
    {"name": "OperationT1$subexpression$6", "symbols": [/[mM]/, /[uU]/, /[lL]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$6"]},
    {"name": "OperationT1$subexpression$7", "symbols": [/[dD]/, /[iI]/, /[vV]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$7"]},
    {"name": "OperationT1$subexpression$8", "symbols": [/[cC]/, /[mM]/, /[pP]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT1", "symbols": ["OperationT1$subexpression$8"]},
    {"name": "OperationT2$subexpression$1", "symbols": [/[cC]/, /[aA]/, /[lL]/, /[lL]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT2", "symbols": ["OperationT2$subexpression$1"]},
    {"name": "OperationT2$subexpression$2", "symbols": [/[jJ]/, /[mM]/, /[pP]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT2", "symbols": ["OperationT2$subexpression$2"]},
    {"name": "OperationT3$subexpression$1", "symbols": [/[rR]/, /[eE]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT3", "symbols": ["OperationT3$subexpression$1"]},
    {"name": "OperationT4$subexpression$1", "symbols": [/[jJ]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$1"]},
    {"name": "OperationT4$subexpression$2", "symbols": [/[jJ]/, /[nN]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$2"]},
    {"name": "OperationT4$subexpression$3", "symbols": [/[jJ]/, /[lL]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$3"]},
    {"name": "OperationT4$subexpression$4", "symbols": [/[jJ]/, /[gG]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$4"]},
    {"name": "OperationT4$subexpression$5", "symbols": [/[jJ]/, /[lL]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$5"]},
    {"name": "OperationT4$subexpression$6", "symbols": [/[jJ]/, /[gG]/, /[eE]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$6"]},
    {"name": "OperationT4$subexpression$7", "symbols": [/[jJ]/, /[lL]/, /[eE]/, /[uU]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$7"]},
    {"name": "OperationT4$subexpression$8", "symbols": [/[jJ]/, /[gG]/, /[uU]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$8"]},
    {"name": "OperationT4$subexpression$9", "symbols": [/[jJ]/, /[cC]/, /[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$9"]},
    {"name": "OperationT4$subexpression$10", "symbols": [/[jJ]/, /[nN]/, /[eE]/, /[gG]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$10"]},
    {"name": "OperationT4$subexpression$11", "symbols": [/[jJ]/, /[vV]/, /[sS]/], "postprocess": function(d) {return d.join(""); }},
    {"name": "OperationT4", "symbols": ["OperationT4$subexpression$11"]},
    {"name": "OperationT5$subexpression$1", "symbols": [/[nN]/, /[oO]/, /[tT]/], "postprocess": function(d) {return d.join(""); }},
    ...
    {"name": "Register$subexpression$1", "symbols": [/[rR]/], "postprocess": function(d) {return d.join(""); }},
    ...
    {"name": "Immediate$subexpression$1$subexpression$1", "symbols": [{"literal":"0"}, /[xX]/], "postprocess": function(d) {return d.join(""); }},
