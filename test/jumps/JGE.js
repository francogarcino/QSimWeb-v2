...
describe('Conditional Jumps', function () {
  it('JGE should jump when number is greater', function () {
    ...
    computer.load_many([{
      instructions: [
        ...
        new Instructions.JGE(new labels.LabelReference("salto")),
  ...
  it('JGE should jump when number is equal', function () {
    const r1 = new Register(1)
    const r2 = new Register(2)
    computer.load_many([{
      instructions: [
  ...
  it('JGE should jump when number is greater with sign', function () {
    const r1 = new Register(1)
    const r2 = new Register(2)
    computer.load_many([{
      instructions: [
        new Instructions.MOV(r1, new Immediate("0xFFFF")),
        new Instructions.MOV(r2, new Immediate("0xFFEE")),
        new Instructions.CMP(r1, r2),
        new Instructions.JGE(new labels.LabelReference("salto")),
        new Instructions.MOV(r1, new Immediate("0x0002")),
        new labels.Label("salto", new Instructions.MOV(r2, new Immediate("0x0003")))
  ...
  it('JGE should not jump when number is lower', function () {
    const r1 = new Register(1)
    const r2 = new Register(2)
    computer.load_many([{
      instructions: [
