...
describe('Conditional Jumps', function () {
  it('JGU should jump when number is greater', function () {
    ...
    computer.load_many([{
      instructions: [
        ...
        new Instructions.JGU(new labels.LabelReference("salto")),
  ...
  it('JGU should not jump when number is lower', function () {
    const r1 = new Register(1)
    const r2 = new Register(2)
    computer.load_many([{
      instructions: [
