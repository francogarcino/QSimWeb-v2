...
describe('Conditional Jumps', function () {
  it('JCS should jump when number is lower', function () {
    ...
    computer.load_many([{
      instructions: [
        ...
        new Instructions.JCS(new labels.LabelReference("salto")),
  ...
  it('JCS should not jump when number is greater', function () {
    const r1 = new Register(1)
    const r2 = new Register(2)
    computer.load_many([{
      instructions: [
